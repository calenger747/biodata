                                    ...
                                    <div class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="<?php echo base_url()?>assets/images/big/img5.jpg" alt="First slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="<?php echo base_url()?>assets/images/big/img6.jpg" alt="Second slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="<?php echo base_url()?>assets/images/big/img5.jpg" alt="Third slide">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="bootstrap-carousel">
                                    <div data-ride="carousel" class="carousel slide" id="carouselExampleCaptions">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="<?php echo base_url()?>assets/images/big/img5.jpg" alt="">
                                            ...
                                            <div class="carousel-item">
                                                <img alt="" class="d-block w-100" src="<?php echo base_url()?>assets/images/big/img6.jpg">
                                                <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <div class="carousel-item active">
                                                <img alt="" class="d-block w-100" src="<?php echo base_url()?>assets/images/big/img5.jpg">
                                                <div class="carousel-caption d-none d-md-block">
