                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="mr-3 img-fluid" src="<?php echo base_url()?>assets/images/avatar/1.jpg" alt="Generic placeholder image">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="mr-3" src="<?php echo base_url()?>assets/images/avatar/1.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                            <h5 class="mt-0">Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi
                                            vulputate fringilla. Donec lacinia congue felis in faucibus.
                                            <div class="media mt-3">
                                                <a class="pr-3" href="#">
                                                    <img src="<?php echo base_url()?>assets/images/avatar/1.jpg" alt="Generic placeholder image">
                                                </a>
                                                <div class="media-body">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-start mr-3" src="<?php echo base_url()?>assets/images/avatar/1.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-center mr-3" src="<?php echo base_url()?>assets/images/avatar/1.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-end mr-3" src="<?php echo base_url()?>assets/images/avatar/1.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="custom-media-object-2">
                                    <div class="media border-bottom-1 p-t-15">
                                        <img class="mr-3 rounded-circle" src="<?php echo base_url()?>assets/images/avatar/1.jpg" alt="">
                                        <div class="media-body">
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <h5>John Tomas</h5>
                                    ...
                                    <div class="media border-bottom-1 p-t-15">
                                        <img class="mr-3 rounded-circle" src="<?php echo base_url()?>assets/images/avatar/2.jpg" alt="">
                                        <div class="media-body">
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <h5>Elora Smith</h5>
                                    ...
                                    <div class="media border-bottom-1 p-t-15">
                                        <img class="mr-3 rounded-circle" src="<?php echo base_url()?>assets/images/avatar/3.jpg" alt="">
                                        <div class="media-body">
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <h5>John Abraham</h5>
