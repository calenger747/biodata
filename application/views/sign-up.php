        ...
        <div class="col-xl-5 col-lg-6 col-md-10">
          <div class="card">
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Sign Up User</span>
                </a>
              </div>
            </div>
            <div class="card-body p-5">
              ...
              <form action="<?php echo base_url();?>Login/sign_up_action" method="post">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <p>Don't have an account yet ?
                      <a class="text-blue" href="<?= base_url(); ?>Login">Sign In</a>
                    </p>
                  </div>
                </div>
              </form>
